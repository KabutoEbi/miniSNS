...
import 'package:minisns/view/account/edit_account_page.dart';
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              children: [
                Container(
                  padding: EdgeInsets.only(right: 15, left: 15, top: 20), height: 200,
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Row(
                            children: [
                              CircleAvatar(radius: 32, foregroundImage: NetworkImage(myAccount.imagePath,),),
                              SizedBox(width: 10),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                ...
                Container(
                  ...
                  child: Text('Posts', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold,),),
                ),
                Expanded(
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        CircleAvatar(radius: 22, foregroundImage: NetworkImage(myAccount.imagePath,),),
                                        Expanded(
                                          child: Container(
                                            child: Column(
                                              crossAxisAlignment:CrossAxisAlignment.start,
